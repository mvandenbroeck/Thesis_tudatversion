#ifndef SPACECRAFTGEN_H
#define SPACECRAFTGEN_H
...
public:
    ...
    Eigen::Matrix< double, 1, 8 > getInitialState() {return initialState_;}
    Eigen::VectorXd getInitialReducedState() {return initialReducedState_;}
    ...
    void setCurrentState( Eigen::Matrix< double, 1, 8 > currentState )
...
private:
    ...
    Eigen::VectorXd initialReducedState_;

    Eigen::Matrix< double, 1, 8 > initialState_;
    Eigen::Matrix< double, 1, 8 > currentState_;
...
typedef boost::shared_ptr< SpacecraftGen > SpacecraftGenPointer;

#endif // SPACECRAFTGEN_H
